...
export default class Preload extends Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('bottoms', require('../assets/characters/bottoms.png'), {
            frameWidth: 32,
            frameHeight: 34,
            endFrame: 10
        });
        ...
        this.load.spritesheet('hair', require('../assets/characters/hair.png'), {
            frameWidth: 32,
            frameHeight: 34,
            endFrame: 72
        });
        this.load.spritesheet('weapons', require('../assets/characters/weapons.png'), {
            frameWidth: 32,
            frameHeight: 34,
            endFrame: 16
        });
